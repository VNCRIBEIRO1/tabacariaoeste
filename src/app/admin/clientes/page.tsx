    ...
    <div className="space-y-6">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b bg-gray-50">
                  ...
                  <th className="text-left p-4 text-sm font-medium text-gray-500">Pedidos</th>
                  <th className="text-left p-4 text-sm font-medium text-gray-500">Total Gasto</th>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2">
          {page > 1 && (
            <Link
              href={`/admin/clientes?page=${page - 1}&search=${search}`}
            >
          ...
          {Array.from({ length: Math.min(totalPages, 10) }, (_, i) => i + 1).map(
            (p) => (
              <Link
                key={p}
                href={`/admin/clientes?page=${p}&search=${search}`}
              >
                <Button
